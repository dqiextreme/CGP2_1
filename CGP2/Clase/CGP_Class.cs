...
{
    public class CGP_Class
    {
        T3WEB_2012Entities1 _oModelos = new T3WEB_2012Entities1();
        public static Pedido model = new Pedido();
        public static string _Str_Vendedor = "S042_58";
        public static string _Str_Ccomp = "S042";
        public static string _Str_Grcomp = "4";


        public Pedido master_model(List<string> Prod_Carga)
        {
            model.ClienteID = 349;
        ...
        public void InformacionCliente(Pedido model)
        {
            ...
            var strGroupCompUsuaro = "4";
            var strZonaUsuario = "C-01";
            var oCliente =
        ...
        private int IdentificarTipoPedido(int pTipoPedidoID, string pCompUsuaro, IEnumerable<string> pProductosCarga)
        {
            ...
            var bAlimentos = _oModelos.VST_T3_PRODUCTOFULLINFO_AL.Where(
                x =>
                    x.ccompany == pCompUsuaro && x.cvendedor == _Str_Vendedor &&
        ...
        public void rec(string js)
        {
            ...
            //direcciones
            var oCliente = _oModelos.VST_T3_CLIENTEFULLINFO.Where(x =>
                x.cvendedor.ToString() == "S01_108" && x.cgroupcomp == "1" && x.ccliente == model.ClienteID);
            ...
            //model.PedidoID = CodigoPedido();

            model.TipoContribuyente = "2";
            model.TipoPedidoID = 3;
        ...
        public void receive()
        {
            ...
            var oCliente = _oModelos.VST_T3_CLIENTEFULLINFO.Where(x =>
                x.cvendedor.ToString() == "S01_108" && x.cgroupcomp == "1" && x.ccliente == 1234);
            var pTuplaList = new List<Tuple<int, int, string, bool>>();
            oCliente.ToList().ForEach(
                x => pTuplaList.Add(new Tuple<int, int, string, bool>(int.Parse(x.c_direcc_despa.ToString()),
                    int.Parse(x.c_direcc_despa.ToString()),
                    x.c_direcc_descrip, pTuplaList.Count() == 0)));
            CargarDirecciones(ped, pTuplaList);

            List<Producto> lstprod = new List<Producto>();
            lstprod.Add(new Producto { Cajas = 1, ProductoID = "434324" });
            ped.Productos = lstprod;
        }
        ...
        ////    var productosExistentes = ProductosExistentes(model.TipoPedidoID, pCompUsuaro, productosCarga);
        ...
        //                                         !string.IsNullOrEmpty(Request["btnFinalizar"])
        //                                         ? "MensajeValidacionID" : "MensajeValidacionIDValidar",
        //                    "Debe corregir el detalle del pedido.");
        //                break;
        //            case 3:
        //                ModelState.AddModelError(
        //                                         !string.IsNullOrEmpty(Request["btnFinalizar"])
        //                                         ? "MensajeValidacionID" : "MensajeValidacionIDValidar",
        //                    "No debe mezclar alimentos y otros.");
        //                break;
        //            case 5:
        //                ModelState.AddModelError(
        //                                         !string.IsNullOrEmpty(Request["btnFinalizar"])
        //                                         ? "MensajeValidacionID" : "MensajeValidacionIDValidar",
        //                    "El monto del pedido es menor al monto mínimo exigido para un cliente especial.");
        //                break;
        //            case 6:
        //                ModelState.AddModelError(
        //                                         !string.IsNullOrEmpty(Request["btnFinalizar"])
        //                                         ? "MensajeValidacionID" : "MensajeValidacionIDValidar",
        //                    "El pedido no debe superar 22 items.");
        //                break;
        //            default:
        ...
        //                                "Las observaciones no deben sobrepasar los 255 carácteres.");
        //                    }
        //                    else if (string.IsNullOrEmpty(model.FormaPagoID))
        //                    {
        //                        ModelState.AddModelError("MensajeValidacionID",
        //                            "Debe elegir la forma de pago.");
        //                    }
